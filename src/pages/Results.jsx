...
import { AI_PROVIDER } from '../services/groqService'
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.strip}>
        <span className={styles.aiChip}><span className={styles.aiDot}/>  {AI_PROVIDER.badge}</span>
      ...
      <div className={styles.disclaimer}>
        <strong>Clinical decision support only.</strong> AI-generated using Groq ({AI_PROVIDER.modelLabel}) cross-referenced against FDA, RxNorm, DailyMed, and patient profile. All findings must be verified by a licensed healthcare professional before any clinical decisions.
      </div>
    </div>
  )
}
