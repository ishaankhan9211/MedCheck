    ...
    <div className={styles.page}>
      <div className={styles.hdr}>
        <div>
          ...
          <p className={styles.sub}>{entries.length} saved {entries.length === 1 ? 'analysis' : 'analyses'} — synced to your account</p>
        </div>
      ...
      {loading ? (
        <div className={styles.empty}>
          <p className={styles.emptySub}>Loading your history…</p>
        </div>
      ) : entries.length === 0 ? (
        <div className={styles.empty}>
