...
const FEATURES = [
  ...
  { icon: '⬡', title: 'Ultra-fast Groq inference', desc: 'Full drug interaction analysis typically completes in a few seconds, powered by Groq\u2019s LPU hardware.' },
]
    ...
    <div className={styles.page}>
      <section className={styles.hero}>
        ...
        <div className={styles.sources}>
          ...
          <span className={styles.srcChip} style={{color:'#f55036',borderColor:'rgba(245,80,54,0.3)'}}>Groq AI</span>
