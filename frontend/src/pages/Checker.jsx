...
import { analyzePatient, fetchAIProvider, AI_PROVIDER_FALLBACK } from '../services/groqService'
...
export default function Checker() {
  ...
  const handleAnalyze = async () => {
    ...
    const msgs = [
      ...
      `Running ${provider.modelLabel} analysis…`,
    ...
    <div className={styles.loadingPage}>
      <div className={styles.loadingBox}>
        ...
        <div className={styles.loadSources}>
          ...
          <span className={styles.dot} style={{marginLeft:16}}/> {provider.badge}
        </div>
      </div>
    </div>
  )
